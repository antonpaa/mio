...
Source version 2 - 27 resources, 445 explicit grants. A cell is the CONDITION under which
the action is permitted; `deny` means no path exists.

| Resource.action | Audit | patient | treatment member | treatment lead | administrator | auditor |
|---|---|---|---|---|---|---|
...
| `activity.remind` | always | — | **team member** | **team member** | — | — |
...
| `notification.view` | always | **self** | **self** | **self** | — | — |
| `notification.mark_read` | never | **self** | **self** | **self** | — | — |
